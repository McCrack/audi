...
<html>
	<head>
		...
		<script src="/xhr/wordlist?d[0]=base&d[1]=modules&d[2]=settings" defer charset="utf-8"></script>
		...
		<div id="wrapper">
			...
			<aside class="body-bg">
				...
				<form id="leftbar-tabs" class="v-bar l" autocomplete="off">
					...
					<div class="toolbar">
						<label title="default subdomain" class="tool" data-translate="title" onclick="new Box(null, 'xhr/boxfather/subdomainselect')">&#xe995;</label>
