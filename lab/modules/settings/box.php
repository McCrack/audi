	...
	<form class="box settings-box h-bar-bg">
				...
				(function(aside){
					...
					aside.querySelectorAll("a").forEach(function(itm){
						itm.onclick=function(){
							XHR.push({
								addressee:"/settings/actions/showsubdomain/"+itm.dataset.subdomain+"/"+(itm.dataset.module || ""),
		...
		(function(form){
			...
			form.onsubmit=function(){
				...
				XHR.push({
					addressee:"/settings/actions/save/"+form.subdomain.value+"/"+form.module.value,
