...
<div id="<?=$handle?>" class="mount" style="width:820px;">
	...
	<form class="box pattern-box white-bg">
		...
		<div class="box-caption logo-bg">JS<?include_once("components/movebox.php")?></div>
		<div class="h-bar logo-bg">
			<input name="path" value="patterns/js" required>
		...
		(function(form){
			...
			form['create-folder'].onclick=function(event){
				...
				promptBox("new folder name", function(promptForm){
					XHR.push({
						addressee:"/patterns/actions/create-folder/js",
...
<?php
function patterns_tree($root="patterns/js", $level=0){
