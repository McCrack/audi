...
<div id="<?=$handle?>" class="mount" style="width:820px;">
	...
	<form class="box pattern-box white-bg">
		...
		<div class="box-caption dark-btn-bg">PHP<?include_once("components/movebox.php")?></div>
		<div class="h-bar dark-btn-bg">
			<input name="path" value="patterns/php" required>
		...
		(function(form){
			...
			form['create-folder'].onclick=function(event){
				...
				promptBox("new folder name", function(promptForm){
					XHR.push({
						addressee:"/patterns/actions/create-folder/php",
...
<?php
function patterns_tree($root="patterns/php", $level=0){
