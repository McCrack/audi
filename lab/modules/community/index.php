				...
				<div class="tabs">
					...
					<form id="citizen" class="tab light-btn-bg">
						...
						<div id="general" class="body-bg light-txt">
							<span><small>ID:</small> <?=$citizen['CommunityID']?></span>
						...
						(function(form, e){
							...
							form.options.onclick=function(event){
								...
								if(form.CommunityID.value){
									XHR.push({
										addressee:"/community/actions/save/"+form.CommunityID.value,
							...
							form.save.onclick=function(event){
								event.preventDefault();
								XHR.push({
									addressee:"/community/actions/change-review/"+form.CommunityID.value,
							...
							form.onsubmit=function(event){
								event.preventDefault();
								XHR.push({
									addressee:"/community/actions/add-to-staff/"+form.CommunityID.value,
									onsuccess:function(response){
										if(isNaN(response)){
											alertBox(response);
