...
function showPattern(json, onapply){
	if(json){
		...
		var edt;
		var pattern = new Box('{}', "patterns/json_patternbox");
...
var alertBox = function(msg, classes){
	if(isNaN( translate.names.inArray("alerts") )){
		XHR.push({
			addressee:"/xhr/wordlist/addwordlist/alerts",
	...
	var box = new Box(JSON.encode(classes), "xhr/boxfather/alertbox");
	box.onopen = function(){
...
var confirmBox = function(msg, onsubmit, classes){
	...
	classes = classes || ["light-btn-bg"];
	var box = new Box(JSON.encode(classes), "xhr/boxfather/confbox", onsubmit);
	box.onopen = function(){
		box.window.alert.value = translate[msg];
	}
}
var promptBox = function(msg, onsubmit, classes){
	...
	classes = classes || ["light-btn-bg"];
	var box = new Box(JSON.encode(classes), "xhr/boxfather/prompt", onsubmit);
