...
var Box = function(params, source, onsubmit){
	...
	XHR.push({
		...
		onsuccess:function(response){
			...
			if ($("#default")[0]) {
				document.querySelector(".main .default").appendChild(mount);
				box.window.parentElement.style.display = "block";
				fadeIn(box.window.parentElement, 300);
			} else {
	...
	// box.drop=function(){
	// 	if ($("#default")[0]) {
	// 		document.querySelector(".main .default").removeChild(box.mount);
	// 	} else {
	// 		document.querySelector(".main").removeChild(box.mount);
	// 	}
...
/* HTMLFragment / HTMLElement *****************************************************************************************/
    ...
    DocumentFragment.prototype.appendList = HTMLElement.prototype.appendList = function(lst){
		lst.forEach(function(nod){
